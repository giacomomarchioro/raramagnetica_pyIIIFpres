...
last_label = None
idx = 0
with open('metadata_v3.csv') as csv_file, open('imageurllist.txt') as url_list:
    ...
    for d in data:
        ...
        if d['structure'] != "":
            ...
            counter_rangel2 = 0
            stru_level1.add_label('none',d['structure'])
        ...
        if d['sub_section'] != "":
            ...
            counter_rangel3 = 0
            stru_level2.add_label('none',d['sub_section'])
        ...
        if d['subsub_section'] != "":
            ...
            counter_rangel3 +=1
            stru_level3.add_label('none',d['subsub_section'])
